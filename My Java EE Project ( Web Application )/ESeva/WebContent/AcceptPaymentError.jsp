...
<title>Accept Payment Error</title>
...
<h3 style="font-size:32px; border:3px solid black; padding:10px">Accept Payment</h3>
<p>Please enter Challan Id of the Violator from list below and press submit to accept payment.</p>
<H3 style="color:red">You entered wrong Challan Id<H3>
</div>

<br>
<form method="post" action="RediPay">
  <div class="mainn">
  <br>
...
<%
	ArrayList<ViolatorPojo> ar = PaymentDao.getDetailsForPayment();
	ViolatorPojo vp;
