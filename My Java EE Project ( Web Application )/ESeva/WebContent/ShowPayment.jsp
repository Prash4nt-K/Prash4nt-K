...
<br><br><br><br><br><br>
<div class="para">
<p>All payment related details and accepting amount.</p>
</div>

<%
	String cid = request.getParameter("cid");
	ViolatorPojo vp = PaymentDao.getDetailsOfPayment(cid);
	
	if(PaymentDao.check2 == true)
	{
	...
	ses.setAttribute("challanID",vp.getCid());
	
	}
	else
	{
		response.sendRedirect("AcceptPaymentError.jsp");
	}
%>
