...
private java.util.Date d;
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(jpatientId, javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(jdoctorId, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                        .addGap(82, 82, 82)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void loadDoctorId(){
        try{
            doctor=DoctorDao.getListOfDocidOfDoctor();
            System.out.println(doctor.toString());
            for (String str:doctor)
            {
                jdoctorId.addItem(str);
            }
        }
    ...
    private void newPatientIdAndDate(){
        ...
        jdate.setText(str);
        try{
            String str1=PatientDao.getNextPatientIdFromPatientTable ();
            jpatientId.setText(str1);
        }
           catch(SQLException ex){
            JOptionPane.showMessageDialog(null,"Error in Database","Error", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
    ...
    public Boolean validateInput()
    {
        ...
        doctor_id=(String)jdoctorId.getSelectedItem();
        s_name=jsecondName.getText();
        age=Integer.parseInt(jage.getText());
        p_id=jpatientId.getText();
        opd=jopd.getText();
    ...
    public String sendSms(){
        try{
            String apiKey="apikey=" +"R5vN2LnTcLw-PeBG6Wo064ve47W9dB1XPDR1MdkOcM";
           ...
           rd.close();
            ...
            System.out.println("erroe SMs "+e);
            return "Error "+e;
 ...
 public void addPatientDetails(){
     {
         ...
         if(refs==ans){
             PatientPojo pp=new PatientPojo(opd,f_name,s_name,doctor_id,age,p_id,gender,m_status,address,city,mno,date);
         try{
             boolean result=PatientDao.addPatientInDatabase(pp);
             if(result){
                 JOptionPane.showMessageDialog(null,"Success!","Appointment Booked Successfully", JOptionPane.INFORMATION_MESSAGE);
             ...
             ex.printStackTrace();
             JOptionPane.showMessageDialog(null,"Exception ","Error in DB while Inseritinmg! ", JOptionPane.ERROR_MESSAGE);
         }
         }
         else
         {
             JOptionPane.showMessageDialog(null,"Plese enter Valid Otp","wrong", JOptionPane.ERROR_MESSAGE);
             count--;
         }
