...
public class RemoveDoctorFrame extends javax.swing.JFrame {
    ...
    try
    {
     boolean check = DoctorDao.deleteDoctor(todelete);
        if(check==false)
        {
        JOptionPane.showMessageDialog(null,"Doctor could not be deleted");
        }
        else
        {
...
private void loadReceptionistEmpid()
{
    try
    {
         ArrayList <String> empidList =DoctorDao.getListOfEmpidOfDoctor();
          if(empidList.size()==0){
