...
public class UpdateEmployeeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcbEmpId.setBackground(new java.awt.Color(0, 204, 255));
        ...
        jcbjob.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Receptionist", "Doctor", "Manager" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(jcbjob, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addComponent(back))))
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try
        {
            id = String.valueOf(jcbEmpId.getSelectedItem());
            String name = jtfempname.getText();
            String job = String.valueOf(jcbjob.getSelectedItem());
            salary = Integer.parseInt(jtfsalary.getText());
            if(EmpDao.updateEmployeeDataInDatabase(id,name,job,salary)==true)
            {
                JOptionPane.showMessageDialog(null,"Employee updated successfully","!",JOptionPane.INFORMATION_MESSAGE);
            }
            else{
